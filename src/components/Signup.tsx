...
export const Signup = () =>{
  ...
  return (
    <>
    <h1 className='title'><span>Welcome to </span><span>Clean Storemap Web</span></h1>
    <div className="signup-area">
      <video autoPlay muted loop className='video'>
        <source src={videoSource} type="video/mp4" />
      </video>
      <div className='signup-area-button'>
        <button onClick={handleSignup} id="signup-btn">Googleでサインアップする</button><br/>
        <a href="login" id="login-link">ログインの方はこちら</a>
      </div>
    </div>
    </>
  )
