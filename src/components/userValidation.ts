...
function setErrorMessageToDisplay(errorMessages: string) :Array<string>{
  ...
  errorMessages.split("\n").forEach((errorMessage) => {
    (errorMessage.includes("Name"))?  displayedErrorMessages.push("nameが空欄です。"): "";
    (errorMessage.includes("Email"))? displayedErrorMessages.push("Emailに誤りがあるため確認してください。"): "";
    (stringHelpers.includesAny(errorMessage,"年齢","Age"))? displayedErrorMessages.push("年齢を選択してください。"): "";
  })
